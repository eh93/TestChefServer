...
CHEF_SERVER_NAME="TestServer" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="testserver-yprd2bu1ftiraomh.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
